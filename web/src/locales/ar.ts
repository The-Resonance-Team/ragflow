    ...
    knowledgeDetails: {
      ...
      document: {
        ...
        restoreConfirmContent:
          'سيؤدي هذا إلى إنشاء إصدار جديد من المحتوى المحدد وإعادة تشغيل التحليل. هل تريد المتابعة؟',
        alreadyCurrent: 'هو بالفعل الإصدار الحالي',
        restoreSuccess: 'تمت الاستعادة بنجاح، جارٍ إعادة التحليل',
        currentBadge: 'الحالي',
        originUpload: 'رفع',
        originRestore: 'استعادة',
        version: 'الإصدار',
        time: 'الوقت',
        actor: 'المستخدم',
        size: 'الحجم',
