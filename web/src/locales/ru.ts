...
`,
      ...
      reRankModelWaring: 'Rerank модель очень требовательна ко времени.',
        ...
        restoreConfirmContent:
          'Будет создана новая версия из выбранного содержимого и повторный парсинг. Продолжить?',
        alreadyCurrent: 'Уже текущая версия',
        restoreSuccess: 'Успешно восстановлено, повторный парсинг',
        currentBadge: 'Текущая',
        originUpload: 'Загрузка',
        originRestore: 'Восстановление',
        version: 'Версия',
        time: 'Время',
        actor: 'Пользователь',
        size: 'Размер',
